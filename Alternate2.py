#!/usr/bin/env python3
"""
Galaxy Tetris — merged:
- Controller support (joystick axis, buttons, D-pad, Start restart)
- Pastel palette, ghost blocks, starfield, particle explosions
- Difficulty stages that change fall speed & preview count
- Animated next-piece previews & UI
- Sound manager with robust fallbacks

Files expected (optional):
- clear.mp3, explosion.mp3, gameover.mp3, bgsound.mp3  (or change names in SoundManager)
Place them in same folder or assets/ directory.
"""
...
class TetrisGameMerged:
    ...
    def reset_game(self) -> None:
        ...
        self.game_state = GameStateData()
        self.stage_info = StageInfo()
        self.effects = VisualEffects(stars=
